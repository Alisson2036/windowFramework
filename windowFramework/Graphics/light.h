...
private:
	...
	ConstantPixelBuffer<DirectX::XMVECTOR> buf;         // Pixel constant buffer para posição da luz
	ConstantVertexBuffer<DirectX::XMMATRIX> matBuf;     // Vertex constant buffer para a matriz de projeção da luz
};